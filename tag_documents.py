#!/usr/bin/env python3
"""
tag_documents.py — Universal Document Tagger (Centralized raw/ version)
...
def infer_agent_from_filename(slug: str) -> str:
    """Use AGENT_PATTERNS to guess the most likely primary agent"""
    from doc_type_taxonomy import AGENT_PATTERNS
    best_agent = "president"  # safe default
    max_matches = 0
...
import re  # for infer_agent_from_filename
...
def main():
    ...
    logger.info(f"   Next: Proceed to chunk_documents.py")
